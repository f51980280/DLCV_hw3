...
train_folder = "/root/anaconda3/envs/hw3/train"
test_folder  = "/root/anaconda3/envs/hw3/test"
extra_folder = "/root/anaconda3/envs/hw3/extra"
resize_size = (64,64)
...
def construct_all_data(img_folder,mat_file_name,h5_name):
    ...
    img_bbox_data_grouped = img_bbox_data.groupby('img_name',as_index=False).apply(collapse_col) 
    img_data = image_data_constuctor(img_folder, img_bbox_data_grouped)
    
    #img_data.index.name = None
    #img_bbox_data_grouped.index.name
