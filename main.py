...
def parse_args(args):
    ...
    parser.add_argument('--lr',               help='Learning rate.', type=float, default=1e-5)  ##############################################1e-5
    ...
    parser.add_argument('--image-max-side',   help='Rescale the image if the largest side is larger than max_side.', type=int, default=416)
...
if __name__ == '__main__':
    ...
    main(["pascal",
          "/root/anaconda3/envs/hw3/train_all/",
          "/root/anaconda3/envs/hw3/train_all_anno/",
          "/root/anaconda3/envs/hw3/valid/",
          "/root/anaconda3/envs/hw3/valid_annot/"])
